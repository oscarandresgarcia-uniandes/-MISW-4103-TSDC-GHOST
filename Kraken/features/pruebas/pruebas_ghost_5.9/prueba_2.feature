...
@user1 @webScenario: crear-editar miembro en ghost
Given I navigate to page "http://localhost:2368/ghost/"
  ...
  And I wait for 5 seconds
  And I enter name_member "Camilo Cardenas"  
  And I wait for 3 seconds
  And I enter email_member "CC@Hotmail.es"  
  And I wait for 3 seconds
  And I enter note_member "El Carpintero"  
  And I wait for 3 seconds
  And I click save_member
  And I wait for 7 seconds
  And I click members 
