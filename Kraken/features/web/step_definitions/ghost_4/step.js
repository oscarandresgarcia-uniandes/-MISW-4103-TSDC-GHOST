...
let screenshotCounter = 1; // Inicializa el contador de capturas

//login
When('I enter email {kraken-string}', async function (email) {
    let element = await this.driver.$('[class="gh-input-icon gh-icon-mail"]');
    return await element.setValue(email);
});
When('I enter password {kraken-string}', async function (password) {
    let element = await this.driver.$('[class="password ember-text-field gh-input ember-view"]');
...
When('I click edit_members', async function() {
    let element = await this.driver.$('[href="#/members/655a2c7e270ade0397f48a7f/"]');
    return await element.click();
}) 
//Click eliminar members 
When('I click delete_members_engine', async function() {
    let element = await this.driver.$('#ember188');
    return await element.click();
}) 
When('I click delete_members', async function() {
    let element = await this.driver.$('[class="mr2"]');
    return await element.click();
}) 
