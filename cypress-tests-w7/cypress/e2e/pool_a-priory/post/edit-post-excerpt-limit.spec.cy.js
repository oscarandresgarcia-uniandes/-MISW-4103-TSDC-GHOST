...
describe('Edición de un Post excediendo limite en excerpt', function() {
    
    const postPage = new PostNewPage();
    const postListPage = new PostListPage();

    it('Test para editar un Post con un excerpt que exceda la cantidad de caracteres', function() {
        ...
        postPage.editExcerpt(postTitleExceed)
